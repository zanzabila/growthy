...
class CekPerkembanganP2b24Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cek_perkembangan_p2b24)
        ...
        radio01 = findViewById(R.id.radio_kpsp8Q1)
        radio02 = findViewById(R.id.radio_kpsp8Q2)
        radio03 = findViewById(R.id.radio_kpsp8Q3)
        radio04 = findViewById(R.id.radio_kpsp8Q4)
        radio05 = findViewById(R.id.radio_kpsp8Q5)
        radio06 = findViewById(R.id.radio_kpsp8Q6)
        radio07 = findViewById(R.id.radio_kpsp8Q7)
        radio08 = findViewById(R.id.radio_kpsp8Q8)
        radio09 = findViewById(R.id.radio_kpsp8Q9)
        radio10 = findViewById(R.id.radio_kpsp8Q10)
        btnLanjut = findViewById(R.id.btn_kpsp8)
        tvEmptyAlert = findViewById(R.id.tv_alertKPSP8)
        tvEmptyAlert!!.text = ""
        ...
        btnLanjut.setOnClickListener {
            if (radio01!!.checkedRadioButtonId > -1 &&
                ...
                if (selected02.getText().toString().equals("Ya")) ++count else ++bicara
                if (selected03.getText().toString().equals("Ya")) ++count else ++sosialisasi
                if (selected04.getText().toString().equals("Ya")) ++count else ++bicara
                if (selected05.getText().toString().equals("Ya")) ++count else ++kasar
                if (selected06.getText().toString().equals("Ya")) ++count else ++halus
                if (selected07.getText().toString().equals("Ya")) ++count else ++kasar
                if (selected08.getText().toString().equals("Ya")) ++count else ++sosialisasi
                if (selected09.getText().toString().equals("Ya")) ++count else ++bicara
                ...
                if (umur==24) { // TDD 18-24 bulan
                    val intent = Intent(this, CekPerkembanganP3Bulan18Sampai24::class.java)
                ...
                } else if (umur<30) { // TDD umur 24-30 bulan
                    val intent = Intent(this, CekPerkembanganP3Bulan24Sampai30::class.java)
                    intent.putExtra("umur", umur)
                    intent.putExtra("hasilKPSP", hasilKPSP)
                    intent.putExtra("kasar", kasar)
                    intent.putExtra("halus", halus)
