...
class CekPerkembanganP2b03Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        radio04 = findViewById(R.id.radio_kpspQ4)
        radio05 = findViewById(R.id.radio_kpspQ5)
        radio06 = findViewById(R.id.radio_kpspQ6)
        radio07 = findViewById(R.id.radio_kpspQ7)
        radio08 = findViewById(R.id.radio_kpspQ8)
        radio09 = findViewById(R.id.radio_kpspQ9)
        radio10 = findViewById(R.id.radio_kpspQ10)
        btnLanjut = findViewById(R.id.btn_kpsp1)
        tvEmptyAlert = findViewById(R.id.tv_alertKPSP)
        tvEmptyAlert!!.text = ""
