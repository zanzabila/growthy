...
class CekPerkembanganP2b36Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cek_perkembangan_p2b36)
        ...
        radio01 = findViewById(R.id.radio_kpsp10Q1)
        radio02 = findViewById(R.id.radio_kpsp10Q2)
        radio03 = findViewById(R.id.radio_kpsp10Q3)
        radio04 = findViewById(R.id.radio_kpsp10Q4)
        radio05 = findViewById(R.id.radio_kpsp10Q5)
        radio06 = findViewById(R.id.radio_kpsp10Q6)
        radio07 = findViewById(R.id.radio_kpsp10Q7)
        radio08 = findViewById(R.id.radio_kpsp10Q8)
        radio09 = findViewById(R.id.radio_kpsp10Q9)
        radio10 = findViewById(R.id.radio_kpsp10Q10)
        btnLanjut = findViewById(R.id.btn_kpsp10)
        tvEmptyAlert = findViewById(R.id.tv_alertKPSP10)
        tvEmptyAlert!!.text = ""
