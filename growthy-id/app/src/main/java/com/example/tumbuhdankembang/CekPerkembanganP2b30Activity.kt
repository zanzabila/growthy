...
class CekPerkembanganP2b30Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cek_perkembangan_p2b30)
        ...
        radio01 = findViewById(R.id.radio_kpsp9Q1)
        radio02 = findViewById(R.id.radio_kpsp9Q2)
        radio03 = findViewById(R.id.radio_kpsp9Q3)
        radio04 = findViewById(R.id.radio_kpsp9Q4)
        radio05 = findViewById(R.id.radio_kpsp9Q5)
        radio06 = findViewById(R.id.radio_kpsp9Q6)
        radio07 = findViewById(R.id.radio_kpsp9Q7)
        radio08 = findViewById(R.id.radio_kpsp9Q8)
        radio09 = findViewById(R.id.radio_kpsp9Q9)
        radio10 = findViewById(R.id.radio_kpsp9Q10)
        btnLanjut = findViewById(R.id.btn_kpsp9)
        tvEmptyAlert = findViewById(R.id.tv_alertKPSP9)
        tvEmptyAlert!!.text = ""
        ...
        btnLanjut.setOnClickListener {
            if (radio01!!.checkedRadioButtonId > -1 &&
                ...
                if (selected01.getText().toString().equals("Ya")) ++count else ++bicara
                if (selected02.getText().toString().equals("Ya")) ++count else ++halus
                if (selected03.getText().toString().equals("Ya")) ++count else ++bicara
                if (selected04.getText().toString().equals("Ya")) ++count else ++halus
                if (selected05.getText().toString().equals("Ya")) ++count else ++sosialisasi
                if (selected06.getText().toString().equals("Ya")) ++count else ++kasar
                if (selected07.getText().toString().equals("Ya")) ++count else ++sosialisasi
                if (selected08.getText().toString().equals("Ya")) ++count else ++bicara
                ...
                } else if (umur<36) { // TDD 30-36 bulan
                    val intent = Intent(this, CekPerkembanganP3Bulan30Sampai36::class.java)
                    intent.putExtra("umur", umur)
                    intent.putExtra("hasilKPSP", hasilKPSP)
                    intent.putExtra("kasar", kasar)
                    intent.putExtra("halus", halus)
