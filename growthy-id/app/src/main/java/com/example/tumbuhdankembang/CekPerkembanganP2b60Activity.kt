...
class CekPerkembanganP2b60Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cek_perkembangan_p2b60)
        ...
        radio01 = findViewById(R.id.radio_kpsp14Q1)
        radio02 = findViewById(R.id.radio_kpsp14Q2)
        radio03 = findViewById(R.id.radio_kpsp14Q3)
        radio04 = findViewById(R.id.radio_kpsp14Q4)
        radio05 = findViewById(R.id.radio_kpsp14Q5)
        radio06 = findViewById(R.id.radio_kpsp14Q6)
        radio07 = findViewById(R.id.radio_kpsp14Q7)
        radio08 = findViewById(R.id.radio_kpsp14Q8)
        radio09 = findViewById(R.id.radio_kpsp14Q9)
        radio10 = findViewById(R.id.radio_kpsp14Q10)
        btnLanjut = findViewById(R.id.btn_kpsp14)
        tvEmptyAlert = findViewById(R.id.tv_alertKPSP14)
        tvEmptyAlert!!.text = ""
        ...
        btnLanjut.setOnClickListener {
            if (radio01!!.checkedRadioButtonId > -1 &&
                ...
                if (selected10.getText().toString().equals("Ya")) ++count else ++bicara
