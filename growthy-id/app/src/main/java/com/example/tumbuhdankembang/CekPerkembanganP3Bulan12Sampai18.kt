...
class CekPerkembanganP3Bulan12Sampai18 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cek_perkembangan_p3_bulan12_sampai18)
        ...
        radio01 = findViewById(R.id.radio_tdd4Q1)
        radio02 = findViewById(R.id.radio_tdd4Q2)
        radio03 = findViewById(R.id.radio_tdd4Q3)
        btnLanjut = findViewById(R.id.btn_tdd4)
        tvEmptyAlert = findViewById(R.id.tv_alertTDD4)
        tvEmptyAlert!!.text = ""
