...
class CekPerkembanganP3Bulan24Sampai30 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cek_perkembangan_p3_bulan24_sampai30)
        ...
        radio01 = findViewById(R.id.radio_tdd6Q1)
        radio02 = findViewById(R.id.radio_tdd6Q2)
        radio03 = findViewById(R.id.radio_tdd6Q3)
        btnLanjut = findViewById(R.id.btn_tdd6)
        tvEmptyAlert = findViewById(R.id.tv_alertTDD6)
        tvEmptyAlert!!.text = ""
