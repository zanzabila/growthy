...
class CekPerkembanganP2b66Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cek_perkembangan_p2b66)
        ...
        radio01 = findViewById(R.id.radio_kpsp15Q1)
        radio02 = findViewById(R.id.radio_kpsp15Q2)
        radio03 = findViewById(R.id.radio_kpsp15Q3)
        radio04 = findViewById(R.id.radio_kpsp15Q4)
        radio05 = findViewById(R.id.radio_kpsp15Q5)
        radio06 = findViewById(R.id.radio_kpsp15Q6)
        radio07 = findViewById(R.id.radio_kpsp15Q7)
        radio08 = findViewById(R.id.radio_kpsp15Q8)
        radio09 = findViewById(R.id.radio_kpsp15Q9)
        radio10 = findViewById(R.id.radio_kpsp15Q10)
        btnLanjut = findViewById(R.id.btn_kpsp15)
        tvEmptyAlert = findViewById(R.id.tv_alertKPSP15)
        tvEmptyAlert!!.text = ""
