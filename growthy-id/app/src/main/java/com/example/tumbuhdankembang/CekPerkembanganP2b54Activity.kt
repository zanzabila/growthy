...
class CekPerkembanganP2b54Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cek_perkembangan_p2b54)
        ...
        radio01 = findViewById(R.id.radio_kpsp13Q1)
        radio02 = findViewById(R.id.radio_kpsp13Q2)
        radio03 = findViewById(R.id.radio_kpsp13Q3)
        radio04 = findViewById(R.id.radio_kpsp13Q4)
        radio05 = findViewById(R.id.radio_kpsp13Q5)
        radio06 = findViewById(R.id.radio_kpsp13Q6)
        radio07 = findViewById(R.id.radio_kpsp13Q7)
        radio08 = findViewById(R.id.radio_kpsp13Q8)
        radio09 = findViewById(R.id.radio_kpsp13Q9)
        btnLanjut = findViewById(R.id.btn_kpsp13)
        tvEmptyAlert = findViewById(R.id.tv_alertKPSP13)
        tvEmptyAlert!!.text = ""
