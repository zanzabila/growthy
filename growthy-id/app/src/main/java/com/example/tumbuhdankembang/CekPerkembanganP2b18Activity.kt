...
class CekPerkembanganP2b18Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cek_perkembangan_p2b18)
        ...
        radio01 = findViewById(R.id.radio_kpsp6Q1)
        radio02 = findViewById(R.id.radio_kpsp6Q2)
        radio03 = findViewById(R.id.radio_kpsp6Q3)
        radio04 = findViewById(R.id.radio_kpsp6Q4)
        radio05 = findViewById(R.id.radio_kpsp6Q5)
        radio06 = findViewById(R.id.radio_kpsp6Q6)
        radio07 = findViewById(R.id.radio_kpsp6Q7)
        radio08 = findViewById(R.id.radio_kpsp6Q8)
        radio09 = findViewById(R.id.radio_kpsp6Q9)
        radio10 = findViewById(R.id.radio_kpsp6Q10)
        btnLanjut = findViewById(R.id.btn_kpsp6)
        tvEmptyAlert = findViewById(R.id.tv_alertKPSP6)
        tvEmptyAlert!!.text = ""
        ...
        btnLanjut.setOnClickListener {
            if (radio01!!.checkedRadioButtonId > -1 &&
                ...
                if (umur==18) { // TDD 12-18 bulan
                    val intent = Intent(this, CekPerkembanganP3Bulan12Sampai18::class.java)
                ...
                } else if (umur<21) { //TDD 18-24 bulan
