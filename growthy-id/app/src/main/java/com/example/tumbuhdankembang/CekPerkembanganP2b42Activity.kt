...
class CekPerkembanganP2b42Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cek_perkembangan_p2b42)
        ...
        radio01 = findViewById(R.id.radio_kpsp11Q1)
        radio02 = findViewById(R.id.radio_kpsp11Q2)
        radio03 = findViewById(R.id.radio_kpsp11Q3)
        radio04 = findViewById(R.id.radio_kpsp11Q4)
        radio05 = findViewById(R.id.radio_kpsp11Q5)
        radio06 = findViewById(R.id.radio_kpsp11Q6)
        radio07 = findViewById(R.id.radio_kpsp11Q7)
        radio08 = findViewById(R.id.radio_kpsp11Q8)
        radio09 = findViewById(R.id.radio_kpsp11Q9)
        btnLanjut = findViewById(R.id.btn_kpsp11)
        tvEmptyAlert = findViewById(R.id.tv_alertKPSP11)
        tvEmptyAlert!!.text = ""
