...
class CekPerkembanganP2b72Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cek_perkembangan_p2b72)
        ...
        radio01 = findViewById(R.id.radio_kpsp16Q1)
        radio02 = findViewById(R.id.radio_kpsp16Q2)
        radio03 = findViewById(R.id.radio_kpsp16Q3)
        radio04 = findViewById(R.id.radio_kpsp16Q4)
        radio05 = findViewById(R.id.radio_kpsp16Q5)
        radio06 = findViewById(R.id.radio_kpsp16Q6)
        radio07 = findViewById(R.id.radio_kpsp16Q7)
        radio08 = findViewById(R.id.radio_kpsp16Q8)
        radio09 = findViewById(R.id.radio_kpsp16Q9)
        radio10 = findViewById(R.id.radio_kpsp16Q10)
        btnLanjut = findViewById(R.id.btn_kpsp16)
        tvEmptyAlert = findViewById(R.id.tv_alertKPSP16)
        tvEmptyAlert!!.text = ""
        ...
        btnLanjut.setOnClickListener {
            if (radio01!!.checkedRadioButtonId > -1 &&
                ...
                if (selected03.getText().toString().equals("Ya")) ++count else ++halus
                if (selected04.getText().toString().equals("Ya")) ++count else ++bicara
                if (selected05.getText().toString().equals("Ya")) ++count else ++halus
                if (selected06.getText().toString().equals("Ya")) ++count else ++bicara
