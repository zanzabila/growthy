...
class CekPerkembanganP2b21Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cek_perkembangan_p2b21)

        var umur = intent.getIntExtra("umur", 0)
        radio01 = findViewById(R.id.radio_kpsp7Q1)
        radio02 = findViewById(R.id.radio_kpsp7Q2)
        radio03 = findViewById(R.id.radio_kpsp7Q3)
        radio04 = findViewById(R.id.radio_kpsp7Q4)
        radio05 = findViewById(R.id.radio_kpsp7Q5)
        radio06 = findViewById(R.id.radio_kpsp7Q6)
        radio07 = findViewById(R.id.radio_kpsp7Q7)
        radio08 = findViewById(R.id.radio_kpsp7Q8)
        radio09 = findViewById(R.id.radio_kpsp7Q9)
        radio10 = findViewById(R.id.radio_kpsp7Q10)
        btnLanjut = findViewById(R.id.btn_kpsp7)
        tvEmptyAlert = findViewById(R.id.tv_alertKPSP7)
        tvEmptyAlert!!.text = ""
