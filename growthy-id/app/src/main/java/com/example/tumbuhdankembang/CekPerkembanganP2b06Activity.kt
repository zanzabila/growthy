...
class CekPerkembanganP2b06Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cek_perkembangan_p2b06)
        ...
        radio01 = findViewById(R.id.radio_kpsp2Q1)
        radio02 = findViewById(R.id.radio_kpsp2Q2)
        radio03 = findViewById(R.id.radio_kpsp2Q3)
        radio04 = findViewById(R.id.radio_kpsp2Q4)
        radio05 = findViewById(R.id.radio_kpsp2Q5)
        radio06 = findViewById(R.id.radio_kpsp2Q6)
        radio07 = findViewById(R.id.radio_kpsp2Q7)
        radio08 = findViewById(R.id.radio_kpsp2Q8)
        radio09 = findViewById(R.id.radio_kpsp2Q9)
        radio10 = findViewById(R.id.radio_kpsp2Q10)
        btnLanjut = findViewById(R.id.btn_kpsp2)
        tvEmptyAlert = findViewById(R.id.tv_alertKPSP2)
        tvEmptyAlert!!.text = ""
        ...
        btnLanjut.setOnClickListener {
            if (radio01!!.checkedRadioButtonId > -1 &&
                ...
                if (selected02.getText().toString().equals("Ya")) ++count else ++kasar
                if (selected03.getText().toString().equals("Ya")) ++count else ++kasar
                if (selected04.getText().toString().equals("Ya")) ++count else ++kasar
                ...
                if (selected10.getText().toString().equals("Ya")) ++count else ++sosialisasi
