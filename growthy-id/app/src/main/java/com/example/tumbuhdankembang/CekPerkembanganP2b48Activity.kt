...
class CekPerkembanganP2b48Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        radio04 = findViewById(R.id.radio_kpsp12Q4)
        radio05 = findViewById(R.id.radio_kpsp12Q5)
        radio06 = findViewById(R.id.radio_kpsp12Q6)
        radio07 = findViewById(R.id.radio_kpsp12Q7)
        radio08 = findViewById(R.id.radio_kpsp12Q8)
        radio09 = findViewById(R.id.radio_kpsp12Q9)
        btnLanjut = findViewById(R.id.btn_kpsp12)
        tvEmptyAlert = findViewById(R.id.tv_alertKPSP12)
        tvEmptyAlert!!.text = ""
