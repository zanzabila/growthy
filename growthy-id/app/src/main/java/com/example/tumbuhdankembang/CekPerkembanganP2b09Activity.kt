...
class CekPerkembanganP2b09Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cek_perkembangan_p2b09)
        ...
        radio01 = findViewById(R.id.radio_kpsp3Q1)
        radio02 = findViewById(R.id.radio_kpsp3Q2)
        radio03 = findViewById(R.id.radio_kpsp3Q3)
        radio04 = findViewById(R.id.radio_kpsp3Q4)
        radio05 = findViewById(R.id.radio_kpsp3Q5)
        radio06 = findViewById(R.id.radio_kpsp3Q6)
        radio07 = findViewById(R.id.radio_kpsp3Q7)
        radio08 = findViewById(R.id.radio_kpsp3Q8)
        radio09 = findViewById(R.id.radio_kpsp3Q9)
        radio10 = findViewById(R.id.radio_kpsp3Q10)
        btnLanjut = findViewById(R.id.btn_kpsp3)
        tvEmptyAlert = findViewById(R.id.tv_alertKPSP3)
        tvEmptyAlert!!.text = ""
