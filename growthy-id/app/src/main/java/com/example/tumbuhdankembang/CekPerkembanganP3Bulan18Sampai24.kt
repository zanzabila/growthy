...
class CekPerkembanganP3Bulan18Sampai24 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cek_perkembangan_p3_bulan18_sampai24)

        var hasilKPSP = intent.getStringExtra("hasilKPSP")
        radio01 = findViewById(R.id.radio_tdd5Q1)
        radio02 = findViewById(R.id.radio_tdd5Q2)
        radio03 = findViewById(R.id.radio_tdd5Q3)
        btnLanjut = findViewById(R.id.btn_tdd5)
        tvEmptyAlert = findViewById(R.id.tv_alertTDD5)
        tvEmptyAlert!!.text = ""
